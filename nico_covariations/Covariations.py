...
msna=0.1,ms=5,cmap=matplotlib.rcParams["image.cmap"],saveas='pdf',transparent_mode=False,showit=True,figsize=(8,3.5)):
...
quepath='./inputQuery/',msna=0.1,ms=5,cmap=matplotlib.rcParams["image.cmap"],saveas='pdf',transparent_mode=False,showit=True,figsize=(8,3.5)):
