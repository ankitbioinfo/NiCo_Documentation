    ...
    -------
     ...
     - An Excel sheet with ligand-receptor interaction information for easy access.
      The columns are structured as follows in the sheets:
        ...
        10-11. Pearson correlation of ligand and receptor genes in cell types A and B with the corresponding factors
        12-13. Average expression of ligands and receptors in cell types A and B
        14-15. Fraction of cells expressing these genes with counts greater than zero in cell types A and B
